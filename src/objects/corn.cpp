...
public:
    ...
    void render(Scene &scene) override
    {
        ...
        scene.shader->use();
        //scene.shader->setUniform("OverallColor", color);
...
std::unique_ptr<ppgso::Mesh> Corn::mesh;
std::unique_ptr<ppgso::Shader> Corn::shader;